...
export default function PropertyCard({ property }: PropertyCardProps) {
  ...
  return (
    <div className="premium-card overflow-hidden group">
      ...
      <div className="p-8">
        <h3 className="text-2xl font-bold text-gray-900 mb-3 group-hover:text-brand-red transition-colors">{property.title}</h3>
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={() => window.location.href = `/view-details/${String(property.id)}`}
            className="bg-brand-red text-white px-8 py-3 rounded-xl font-bold hover:bg-brand-red-dark transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1"
          >
            View Details
          </button>
        </div>
