    ...
    <footer className="bg-brand-primary text-white py-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              Your trusted partner in finding the perfect property. Experience excellence with GS Reality.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-brand-primary rounded-full flex items-center justify-center hover:bg-brand-primary-dark transition">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="text-gray-300 hover:text-brand-secondary transition cursor-pointer flex items-center group">
                <span className="w-0 group-hover:w-2 h-0.5 bg-brand-secondary mr-0 group-hover:mr-2 transition-all"></span>
                Buy Property
              </li>
              <li className="text-gray-300 hover:text-brand-secondary transition cursor-pointer flex items-center group">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-start">
                ...
                <span>info@gsreality.com</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-brand-secondary mr-3 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-600 mt-12 pt-8 text-center">
          <p className="text-gray-300">&copy; 2024 GS Reality. All rights reserved. | <span className="text-brand-secondary italic">Excellence in Real Estate</span></p>
        </div>
      </div>
    </footer>
  );
